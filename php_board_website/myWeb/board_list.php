...
<div id="board_box">
	...
	<?php
		...
		{
			$new_page = $page - 1;
			echo "<li><a href='board_list.php?page=$new_page&rep=1'> ◀ 이전</a></li>";
		}
		else
			echo "<li>&nbsp;</li>";
		...
		for ($i=1; $i<=$total_page; $i++)
		{
			...
			{
				echo "<li><a href='board_list.php?page=$i&rep=1'> $i </a></li>";
			}
		}
		if ($total_page >= 2 && $page != $total_page)
		{
			$new_page = $page + 1;
			echo "<li><a href='board_list.php?page=$new_page&rep=1'> 다음 ▶</a></li>";
		}
		else
			echo "<li>&nbsp;</li>";
	?>
